    ...
    $categories = [
      ...
      'accessible' => [
        ...
        'criteria' => [
          ...
          'Q-3.3' => ['title' => 'Der <strong>Link zur Bilddatei</strong> muss valide sein.', 'score' => -9],
          ...
          'Q-4.4' => ['title' => 'Der Datensatz enthält einen <strong>Link zu einer Mediendatei</strong>.', 'score' => 3],
          'Q-4.5' => ['title' => 'Der Datensatz enthält einen <strong>Link zum Objekt im Kontext</strong>', 'score' => 6],
          'Q-4.6' => ['title' => 'Der Datensatz enthält einen <strong>Link zum Objekt im Medienviewer</strong>', 'score' => 0]
        ],
      ],
      'interoperable' => [
        ...
        'criteria' => [
          ...
          'Q-2.4' => ['title' => '<strong>Datengeber</strong>-ID- Der Datengeber soll durch einen International Standard Identifier for Libraries and Related Organisations (ISIL) identifiziert sein.', 'score' => 6],
          'Q-2.5' => ['title' => 'Der <strong>Datengeber-ID</strong> soll durch einen http-URI aus der ISIL-Registrierung referenziert sein.', 'score' => 3],
      ...
      'reusable' => [
        ...
        'criteria' => [
          ...
          'Q-5.7' => ['title' => '<strong>Lizenz</strong>: Es wird ein standardisierter Rechtehinweis verwendet. Die Nutzungsrechte müssen erfragt werden', 'score' => -3]
        ],
      ]
    ];
