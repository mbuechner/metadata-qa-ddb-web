...
<div class="container">
  ...
  <div class="tab-content" id="myTabContent">
    <div class="tab-pane active" id="factors" role="tabpanel" aria-labelledby="factors-tab">
      ...
      <table class="fair">
        <tr>
          <td>Kategorien für Qualitätskriterien (FAIR Prinzipien)</td>
          <td>Beschreibung</td>
          <td>Bewertungs-matrix</td>
          <td>Maximale Punktzahl</td>
        </tr>
        <tr>
          <td class="category" colspan="4">Auffindbarkeit und Identifzierbarkeit</td>
        </tr>
        <tr>
          <td rowspan="8"> </td>
        ...
        <tr>
          <td class="category" colspan="4">Zugänglichkeit</td>
        </tr>
        <tr>
          <td> </td>
        ...
        <tr>
          <td class="category" colspan="4">Interoperabilität und Maschinenlesbarkeit</td>
        </tr>
        <tr>
          <td> </td>
        ...
        <tr>
          <td class="category" colspan="4">Wiederverwendbarkeit</td>
        </tr>
        <tr>
          <td> </td>
