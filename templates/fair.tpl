...
*}
          <th style="width: 100px" class="red">Blocked</th>
          <th style="width: 100px" class="orange">To be improved</th>
          <th style="width: 100px">Acceptable</th>
          <th style="width: 100px" class="green">Good</th>
        </tr>
        </thead>
        <tbody>
